...
- Super Admin local-user controls:
  ...
  - per-user operation access checkboxes for create category, edit device, delete device, delete category (users without access are prompted for super-admin password)
